...
class scalar_tpl : public evaluator::scalar_tpl<ValueType> {
   public:
     ...
     */
    return_status eval_a(Eigen::Ref<dense_vector_t> out) {
     ...
     * @return return_status
     */
    return_status eval_a(sparse_vector_t &out) {
        if (ptr_) return ptr_->eval_a(out);
        return eval_a_impl(out);
    }
     ...
     * @return return_status
     */
    return_status eval_b(value_t &out) {
        if (ptr_) return ptr_->eval_b(out);
        return eval_b_impl(out);
    }

   protected:
    virtual return_status eval_a_impl(Eigen::Ref<dense_vector_t> out) {
        return return_status::NotImplemented;
    }

    virtual return_status eval_a_impl(sparse_vector_t &out) {
        return return_status::NotImplemented;
    }

    virtual void get_a_sparsity_impl(sparse_vector_t &out) const {}

    virtual return_status eval_b_impl(value_t &out) {
        return return_status::NotImplemented;
    }
...
class vector_tpl : public evaluator::vector_tpl<ValueType> {
   ...
   protected:
    virtual return_status eval_A_impl(Eigen::Ref<dense_matrix_t> out) {
        return return_status::NotImplemented;
    }
    ...
    virtual return_status eval_b_impl(Eigen::Ref<dense_vector_t> out) {
        return return_status::NotImplemented;
    }
