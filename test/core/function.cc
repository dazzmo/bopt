...
using namespace bopt;

class NormFunction : public bopt::FunctionBase<1, double> {
 public:
...
class VectorFunction : public bopt::FunctionBase<1, Eigen::VectorXd> {
 public:
...
class BiVectorFunction : public bopt::FunctionBase<2, Eigen::VectorXd> {
 public:
